...
import SeniorListPage from './pages/SeniorListPage.jsx';
...
// === NAYA PAGE IMPORT KAREIN ===
import CourseResultsPage from './pages/CourseResultsPage.jsx';
...
import AdminRoadmapManagementPage from './pages/AdminRoadmapManagementPage.jsx';

// --- Common Private Page Imports ---
        ...
        <div className="app-container">
            ...
            <main>
                <Routes>
                    ...
                    <Route path="/roadmaps" element={<SeniorListPage />} />

                    {/* Common Private Routes (Accessible by Student and Admin) */}
                    ...
                    <Route element={<PrivateRoute roles={['admin']} />}>
                        ...
                        <Route path="/admin/roadmaps" element={<AdminRoadmapManagementPage />} />
                    </Route>
